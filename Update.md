...
<h3> Sites for reference that might help: </h3>
  <ul> 1. General Idea ideas </ul>
    ...
    <li> 2. https://lit.link/en/uiseiu </li>
    <li> 3. </li>
  ...
  Got most of the sites from here:  https://github.com/emmabostian/developer-portfolios
    ...
    <li><s> 2. https://augustopolonio.vercel.app/ </s></li>
      <ul>
        <li> <s><strong>Landing page</strong>; top part of text changing seems nice but everything else is bland. </s></li>
      </ul>
    ...
    <li> <s>4. https://althruist.fyi/ </s></li>
      <ul>
        <s>
